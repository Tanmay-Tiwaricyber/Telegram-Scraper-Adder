...
def banner():
	...
	{re}╚═╝{cy}└─┘ ┴ └─┘┴
	           ...
	           Version : 1.0
	{re}Subscribe Silent Programmer on Youtube
	{cy}www.youtube.com/@silentprogrammerofficial
	""")
banner()
...
print(gr+"[+] https://github.com/Tanmay-Tiwaricyber/TeleGram-Scraper-Adder/blob/master/README.md")
